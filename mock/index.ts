...
router
  ...
  .get(`${baseHref}/translation`, translationListGet)
  .get(`${baseHref}/translation/:id`, translationGet)
  .get(`${baseHref}/other/:id`, otherGet)
  .get(`${baseHref}/other`, otherListGet)
  .post(`${baseHref}/secure/translation`, translationPost)
