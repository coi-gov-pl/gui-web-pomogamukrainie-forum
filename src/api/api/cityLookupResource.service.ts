...
// @ts-ignore
import { CityLookupResponse } from '../model/cityLookupResponse';
...
export class CityLookupResourceService {
  ...
  public getCities(
    ...
    return this.httpClient.get<CityLookupResponse>(`${this.configuration.basePath}/api/dictionaries/city`, {
