...
export default {
  ...
  JOB: 'Praca',
  FINANCES: 'Bankowość/Finanse/Ekonomia',
  HEALTH_AND_SAFETY: 'BHP/Ochrona środowiska',
  ENGINEERING: 'Budownictwo/Energetyka/Inżynieria',
  EDUCATION: 'Edukacja /Szkolenia/Badania i Rozwój',
  HOTEL: 'Hotelarstwo/Gastronomia/Turystyka',
  INTERNET: 'Internet/E-commerce/Nowe media',
  IT: 'IT',
  ENTERTAINMENT: 'Media/Sztuka/Rozrywka',
  REAL_ASSETS: 'Nieruchomości',
  CUSTOMER_SERVICE: 'Obsługa klienta/Call Center',
  DESK_JOB: 'Praca biurowa/Administracja/HR',
  MANUAL_JOB: 'Praca fizyczna',
  CONSULTING: 'Prawo/Doradztwo/Konsulting',
  MANUFACTURING: 'Produkcja/Kontrola Jakości',
  MARKETING: 'Reklama/PR/Marketing',
  PUBLIC_SECTOR: 'Sektor publiczny',
  LOGISTICS: 'Transport/Spedycja/Logistyka',
  TRADE: 'Zakupy/Sprzedaż',
  HEALTH_AND_BEAUTY: 'Zdrowie/Uroda',
  FULL_TIME: 'Pełen etat',
  PART_TIME: 'Część etatu',
  TEMPORARY: 'Tymczasowa/Dodatkowa',
