...
export default {
  ...
  INDUSTRY_1: 'Branża 1',
  INDUSTRY_2: 'Branża 2',
  LABEL_WORK_MODE: 'Tryb',
  PLACEHOLDER_WORK_MODE: 'Wybierz tryb pracy',
  WORK_MODE_1: 'Tryb pracy 1',
  WORK_MODE_2: 'Tryb pracy 2',
  LABEL_CONTRACT_MODE: 'Tryb',
  LABEL_CONTRACT_TYPE: 'Rodzaj umowy',
  PLACEHOLDER_CONTRACT_TYPE: 'Wybierz rodzaj umowy',
  LABEL_WORKING_TIME: 'Wymiar pracy',
  PLACEHOLDER_WORKING_TIME: 'Wybierz wymiar pracy',
  LABEL_WORK_LANG: 'Język',
  CONTRACT_TYPE_1: 'Typ kontraktu 1',
  CONTRACT_TYPE_2: 'Typ kontraktu 2',
  WORKING_TIME_1: 'Wymiar pracy 1',
  WORKING_TIME_2: 'Wymiar pracy 2',
};
