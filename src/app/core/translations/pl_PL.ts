...
export default {
  ...
  PLACEHOLDER_OFFER_DESCRIPTION_MATERIAL_HELP: 'W opisie podaj najważniejsze informacje dotyczące pomocy, którą oferujesz, np. rodzaj odzieży i jej rozmiar.\n\nNapisz ogłoszenie po polsku. Strona przetłumaczy treść osobom, które przeglądają ogłoszenia w innym języku.',
  ...
  FIND_HELP_TITLE: 'Znajdź pomoc - Pomagam Ukrainie',
  VIEW_ACCOMODATION_TITLE: 'Ogłoszenie:  Noclegi - Pomagam Ukrainie',
  ...
  VIEW_TRANSLATION_TITLE: 'Ogłoszenie:  Tłumaczenia - Pomagam Ukrainie',
  VIEW_TRANSPORT_TITLE: 'Ogłoszenie: Transport - Pomagam Ukrainie',
  GIVE_HELP_TITLE: 'Dodaj ogłoszenie - Pomagam Ukrainie',
  GIVE_ACCOMODATION_TITLE: 'Dodaj Ogłoszenie:  Noclegi - Pomagam Ukrainie',
  ...
  GIVE_TRANSLATION_TITLE: 'Dodaj Ogłoszenie:  Tłumaczenia - Pomagam Ukrainie',
  ...
  HELP_UA_LOGO: 'Logo Pomagam Ukrainie - Strona główna',
  CLEAR: 'Wyczyść',
  ...
  CONTENT_HAS_BEEN_TRANSLATED: 'Ogłoszenie zostało przetłumaczone automatycznie przez Microsoft Translator.',
