...
export default {
  ...
  B_ADAMCZYK: 'Błażej Adamczyk',
  B_BARTOSIAK: 'Bartłomiej Bartosiak',
  L_BASIAK : 'Łukasz Basiak',
  B_BLIUJ_STODULSKI : 'Bartosz Bliuj-Stodulski',
  L_BROS: 'Łukasz Broś',
  K_BYSZEWSKA: 'Kinga Byszewska',
  D_HRYHORYEU: 'Dymitr Hryhoryeu(github.com/H-dymitr)',
  M_FENGLER: 'Małgorzata Fengler',
  M_GOLEBIOWSKI_OWCZAREK: 'Michał Gołębiowski-Owczarek (mgol)',
  J_METEOR: 'Jerzy Meteor',
  M_GUMINSKI: 'Mariusz Gumiński',
  K_HARK: 'Kamil Hark',
  J_IWANKOW_MAISON: 'Joanna Iwanków-Maison',
  O_JASKIEWICZ: 'Oskar Jaśkiewicz / Ozzy',
  M_KACPROWICZ: 'Marzena Kacprowicz',
  T_KAMINSKI: 'Tomasz Kamiński',
  P_KANIA: 'Paweł Kania / Vodzoo',
  J_KANIA: 'Julian Kania',
  J_KASPRZYK: 'Jakub Kasprzyk (github.com/neu5)',
  P_KLIMASZEWSKI: 'Piotr Klimaszewski',
  A_KLIS: 'Adam Kliś',
  K_KOPROWSKA: 'Karina Koprowska',
  P_KOWALCZYK: 'Piotr Kowalczyk',
  A_KOZUBEK: 'Artur Kozubek (github.com/archiewald)',
  A_KRZYWICKI: 'Adrian Krzywicki',
  M_KWAPISZ: 'Magdalena Kwapisz',
  M_LEWINSKI: 'Maciej Lewinski',
  B_MAJ: 'Bartłomiej Maj',
  L_MALCHENKO: 'Lana Malchenko',
  Z_MALINSKA: 'Zuzanna Malińska',
  J_MIRECKI: 'Jan Mirecki',
  P_NESCIOR: 'Paweł Neścior',
  M_NIEDZIELSKI: 'Marcin Niedzielski',
  K_NOWICKI: 'Kamil Nowicki',
  B_OLSZANSKI: 'Bartosz Olszański',
  D_POTKANSKI: 'Daniel Potkański',
  J_PRUS: 'Jacek Pruś',
  M_PRZEWOZNIK: 'Maciej Przewoźnik',
  V_RADIUK: 'Volodia Radiuk',
  T_RYCHTER: 'Tomasz Rychter',
  J_RYGALIK_KOLBICZ: 'Justyna Rygalik-Kolbicz',
  K_RZYMKOWSKI: 'Krzysztof Rzymkowski',
  M_SABAK: 'Małgorzata Sabak',
  L_SOLTYK: 'Łukasz Sołtyk',
  D_STANKIEWICZ: 'Diana Stankiewicz',
  D_STASZEL: 'Dominika Staszel',
  U_SWIATLOWSKA: 'Ula Światłowska',
  P_SWIDERSKI: 'Paweł Świderski',
  P_SWISTAK: 'Piotr Świstak',
  P_UFNALEWSKI: 'Paweł Ufnalewski',
  R_URBAN: 'Rafał Urban',
  K_WELKA: 'Katarzyna Welka',
  J_WIENIATOWSKA: 'Joanna Wieniatowska',
  B_WOJCICKI: 'Bartosz Wójcicki',
