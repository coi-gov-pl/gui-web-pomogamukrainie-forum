...
export class MaterialAidResourceService {
  ...
  public deleteMaterialAid(
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling deleteMaterialAid.');
    }
  ...
  public updateMaterialAid(
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling updateMaterialAid.');
    }
    if (materialAidOfferDefinitionDTO === null || materialAidOfferDefinitionDTO === undefined) {
      throw new Error(
        'Required parameter materialAidOfferDefinitionDTO was null or undefined when calling updateMaterialAid.'
      );
    }
